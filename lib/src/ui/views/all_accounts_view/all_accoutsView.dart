...
import 'package:mobile/src/core/states/login/auth_state.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                ProviderListener<BranchesState>(
                  provider: branchesNotifier.state,
                  ...
                  child: Consumer(
                    builder: (context, watch, __) {
                      final state = watch(branchesNotifier.state);
                      ...
                      return state.when(
                          ...
                          loaded: (data) {
                            if (data.isEmpty) {
                              return Center(
                                child: Text('You have no Account yet.'),
                              );
                            } else {
                              return Column(
                                mainAxisSize: MainAxisSize.min,
